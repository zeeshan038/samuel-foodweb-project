    ...
    return (
        <div className='mx-auto mt-36 flex justify-centers flex-col md:flex-row gap-36'>
            <div className='mx-6'>
                ...
                <p className='text-gray-500 mt-10 w-80 md:w-96 '>
            ...
            <div className='flex flex-col justify-center gap-8'>
                {/* //boxes */}
                 <div className='flex gap-8 justify-center mx-4 flex-wrap'>
                      <div className='border p-7 w-full md:w-52 mx-8 md:mx-0  flex flex-col justify-center items-center bg-white shadow-lg rounded-2xl'>
                      ...
                      <div className='border p-7  flex  w-full md:w-52 mx-8 md:mx-0  flex-col justify-center items-center bg-white shadow-lg rounded-2xl'>
